        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-primary active" id="Installation">
            ...
            <div class="box-body">
              ...
              <br/>
              <a href="{{route('install.index')}}" class="btn btn-default pull-left">Voltar</a>

              <a @if($output['next']) href="{{route('install.details')}}" @endif class="btn btn-primary pull-right @if(!$output['next']) disabled-link @endif" @if(!$output['next']) disabled onclick="return false;" @endif>Próximo</a>
            </div>
          <!-- /.box-body -->
          </div>
        </div>
