            ...
            <div class="m-6 mt-5" style="display: flex;">
                <p><strong>@lang('sale.location'): &nbsp;</strong>
                    ...
                    <i class="fa fa-keyboard hover-q text-muted" aria-hidden="true" data-container="body"
                        ...
                        data-html="true" data-trigger="hover" data-original-title="" title=""></i> Atalhos
                </p>
            </div>
        </div>
        <div class="col-md-6">
            <a href="{{ $go_back_url }}" title="{{ __('lang_v1.go_back') }}"
                ...
                <strong><i class="fa fa-backward fa-lg"></i></strong> Voltar
            </a>
			...
			@can('view_cash_register')
                <button type="button" id="register_details" title="{{ __('cash_register.register_details') }}"
                    ...
                    <strong><i class="fa fa-briefcase fa-lg" aria-hidden="true"></i></strong> Caixa
                </button>
            @endcan
			...
			<button type="button" id="view_suspended_sales" title="{{ __('lang_v1.view_suspended_sales') }}"
                ...
                <strong><i class="fa fa-pause-circle fa-lg"></i></strong> Suspensas
            </button>
			 ...
			 @can('expense.add')
                <button type="button" title="{{ __('expense.add_expense') }}" data-placement="bottom"
                    ...
                    <strong><i class="fa fas fa-minus-circle"></i></strong> Despesas
                </button>
            @endcan
			...
			<button type="button" title="{{ __('lang_v1.full_screen') }}"
                ...
                <strong><i class="fa fa-window-maximize fa-lg"></i></strong> Tela Cheia
            </button>
			
			<!-- Botão de treinamento com link para youtube -->
			<a  href="https://youtube.com/playlist?list=PL3-ncRSUBx8UV6dfcSh0DspoXePyy195t" 
                    target="_blank" 
                    title="Vídeos tutoriais" 
                    data-toggle="tooltip"
                    data-placement="bottom" 
                    class="btn btn-danger pull-right m-6 btn-xs m-5 btn-success">
                    <strong><i  class="fa fa-camera"></i></strong> Ajuda
                </a>
		<!-- fim -->
