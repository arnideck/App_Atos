<tr>
    ...
    <td @if($count_child_payments > 0) class="bg-gray" @endif>
        ...
        @if(!empty($transaction_id) && empty($payment->parent_id))
        ...
        @if( empty($transaction_id) || ( empty($payment->parent_id) && ( (in_array($transaction_type, ['purchase', 'purchase_return']) && auth()->user()->can('delete_purchase_payment')) || (in_array($transaction_type, ['sell', 'sell_return']) && auth()->user()->can('delete_sell_payment')) ) ) )
