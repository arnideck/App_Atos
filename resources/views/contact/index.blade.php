...
<script>
var lastPaymentId = "{{ session()->get('status.transaction_payment_id') }}";

function printLastPaymentReceipt(payment_id) {
    let url = "{{ action('TransactionPaymentController@viewPayment', ['#PAYMENT_ID']) }}";
...
if (lastPaymentId) printLastPaymentReceipt(lastPaymentId);
</script>
@endsection
