		...
		<div class="form-group">
			<div class="input-group">
				...
				{!! Form::select('contact_id', 
					[], null, ['class' => 'form-control mousetrap', 'id' => 'customer_id', 'placeholder' => 'Insira o nome/telefone do cliente', 'required']); !!}
				<span class="input-group-btn">
					<button type="button" class="btn btn-default bg-white btn-flat add_new_customer" data-name=""  @if(!auth()->user()->can('customer.create')) disabled @endif><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
                    <button type="button" id="btn-make-payment-R" title="Realizar pagamento de fiado"
                        class="btn btn-default bg-white btn-flat "
                        data-href="{{ action('TransactionPaymentController@postPayContactDue') }}/#ID_CLIENT?type=sell">
                        <strong><i class="fas fa-money-bill-alt"></i></strong>
                    </button>
				</span>
			</div>
			<small id="total-a-receber" class="text-danger hide contact_due_text"><strong>@lang('account.customer_due'):</strong> <span></span></small>
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
