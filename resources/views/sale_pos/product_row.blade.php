...
<tr class="product_row" data-row_index="{{$row_count}}" @if(!empty($so_line)) data-so_id="{{$so_line->transaction_id}}" @endif>
	<td>
		...
		<span class=" cursor-pointer" data-toggle="modal" data-target="#row_edit_product_price_modal_{{$row_count}}">
			{!! $product_name !!}
	...
	<td>
		...
		<div class="input-group input-number">
			<span class="input-group-btn"><button type="button" class="btn btn-success btn-flat quantity-down"><i class="fa fa-minus text-white"></i></button></span>
		<input type="text" data-min="1" 
			...
			@endif 
		>
		<span class="input-group-btn"><button type="button" class="btn btn-success btn-flat quantity-up"><i class="fa fa-plus text-white"></i></button></span>
		</div>
	...
	<td class="text-center v-center">
		<i class="fa fa-trash text-danger pos_remove_row cursor-pointer" aria-hidden="true"></i>
	</td>
</tr>