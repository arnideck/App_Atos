...
<html lang="en">
  <head>
    ...
    <title>Fazendo algumas verificações de pré-instalação...</title>
  ...
  <body>
  	<div class="container">
		...
		<center>
			<h2>Fazendo algumas verificações de pré-instalação...</h2><br/>
		</center>
			...
			<td class="col-md-6">
				<?php
					if($is_writable){
						...
						echo "<i class='glyphicon glyphicon-remove text-danger' aria-hidden='true'></i>";
						echo "<br/>Por favor, forneça permissão gravável para <br/><i>$storage_path</i>";
						$all_ok = false;
					}
				?>
			</td>
			...
			<td>
				<?php
					if(is_writable($cache_path)){
						...
						echo "<i class='glyphicon glyphicon-remove text-danger' aria-hidden='true'></i>";
						echo "<br/>Por favor, forneça permissão gravável para <br/><i>$cache_path</i>";
						$all_ok = false;
					}
				?>
			</td>
			...
			<td>
				<?php
					if(is_writable($upload_path) && is_writable($upload_b_logo) && is_writable($upload_b_doc) && is_writable($upload_b_img) && is_writable($upload_i_logo)){
						...
						echo "<i class='glyphicon glyphicon-remove text-danger' aria-hidden='true'></i>";
						echo "<br/>Forneça permissão gravável (recursiva) para <br/><i>$upload_path</i>";
						$all_ok = false;
					}
				?>
			</td>
		...
		<p>
			<?php
				if($all_ok){
					...
					echo "<span class='text-danger'>Algumas configurações estão incorretas. Corrija-o e atualize esta página</span>";
				}
			?>
		</p>
	</center>
