...
[Get Postman Collection](http://nexusweb.jwsistemas.com.br/docs/collection.json)
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "http://nexusweb.jwsistemas.com.br/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"unde","ip_address":"maiores","latitude":"facilis","longitude":"omnis"}'
...
```bash
curl -X POST \
    "http://nexusweb.jwsistemas.com.br/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"alias","latitude":"consequatur","longitude":"in"}'
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/holidays?location_id=1&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=ipsa&follow_up_type=excepturi&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/crm/follow-ups"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "http://nexusweb.jwsistemas.com.br/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"quos","schedule_type":"sapiente","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=fugiat&biz_name=quas&mobile_num=1&contact_id=laudantium&order_by=est&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "http://nexusweb.jwsistemas.com.br/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"vitae","mobile_name":"deleniti","call_type":"call","start_time":"quos","end_time":"porro","duration":"minus"}]}'
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=1&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"initial_amount":5.3158858,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":6141105.123716331,"total_card_slips":14,"total_cheques":13,"closing_note":"et","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 1,
    "initial_amount": 5.3158858,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 6141105.123716331,
    "total_card_slips": 14,
    "total_cheques": 13,
    "closing_note": "et",
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/contactapi?type=id&name=quas&biz_name=qui&mobile_num=10&contact_id=aspernatur&order_by=repellendus&direction=et&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"cupiditate","prefix":"rerum","first_name":"doloremque","middle_name":"dolorem","last_name":"sit","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"ab","address_line_2":"cumque","city":"veniam","state":"velit","country":"quis","zip_code":"sed","customer_group_id":"perspiciatis","contact_id":"recusandae","dob":"2000-06-13","custom_field1":"quibusdam","custom_field2":"harum","custom_field3":"asperiores","custom_field4":"laudantium","email":"deleniti","shipping_address":"ipsum","position":"eligendi","opening_balance":0,"source_id":18,"life_stage_id":9,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "cupiditate",
    "prefix": "rerum",
    ...
    "dob": "2000-06-13",
    "custom_field1": "quibusdam",
    "custom_field2": "harum",
    "custom_field3": "asperiores",
    "custom_field4": "laudantium",
    "email": "deleniti",
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"nesciunt","prefix":"est","first_name":"voluptas","middle_name":"sed","last_name":"maiores","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"commodi","address_line_2":"consequatur","city":"provident","state":"est","country":"explicabo","zip_code":"architecto","customer_group_id":"qui","contact_id":"voluptas","dob":"2000-06-13","custom_field1":"distinctio","custom_field2":"aliquid","custom_field3":"quia","custom_field4":"soluta","email":"molestiae","shipping_address":"delectus","position":"eos","opening_balance":10.3,"source_id":7,"life_stage_id":20,"assigned_to":[]}'
...
let body = {
    ...
    "contact_id": "voluptas",
    "dob": "2000-06-13",
    "custom_field1": "distinctio",
    "custom_field2": "aliquid",
    "custom_field3": "quia",
    "custom_field4": "soluta",
    "email": "molestiae",
    "shipping_address": "delectus",
    "position": "eos",
...
```bash
curl -X POST \
    "http://nexusweb.jwsistemas.com.br/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":19,"card_number":"eos","card_holder_name":"eius","card_transaction_number":"qui","card_type":"quasi","card_month":"rerum","card_year":"corporis","card_security":"omnis","transaction_no_1":"molestiae","transaction_no_2":"occaecati","transaction_no_3":"assumenda","cheque_number":"atque","bank_account_number":"voluptatem","note":"eveniet"}'
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/expense?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=aperiam&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":34.68,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":20,"expense_for":15,"contact_id":4,"expense_category_id":9,"expense_sub_category_id":15,"additional_notes":"velit","is_refund":0,"is_recurring":0,"recur_interval":20,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"modi","recur_repetitions":3,"payment":[{"amount":453.13,"method":"cash","account_id":18,"card_number":"reprehenderit","card_holder_name":"at","card_transaction_number":"quae","card_type":"architecto","card_month":"aut","card_year":"quis","card_security":"quia","transaction_no_1":"qui","transaction_no_2":"omnis","transaction_no_3":"neque","note":"quibusdam","cheque_number":"molestiae"}]}'
    ...
    "payment": [
        {
            ...
            "card_holder_name": "at",
            "card_transaction_number": "quae",
            "card_type": "architecto",
            "card_month": "aut",
            "card_year": "quis",
            "card_security": "quia",
            "transaction_no_1": "qui",
            "transaction_no_2": "omnis",
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "http://nexusweb.jwsistemas.com.br/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":18106.912984511,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":14,"expense_for":1,"contact_id":10,"expense_category_id":5,"expense_sub_category_id":2,"additional_notes":"excepturi","is_recurring":0,"recur_interval":6,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"quis","recur_repetitions":4,"payment":[]}'
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/expense-refund?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=accusamus&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/expense-categories" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/expense-categories"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/field-force?contact_id=quaerat&assigned_to=omnis&status=sit&start_date=2018-06-25&end_date=2018-06-25&per_page=15&order_by_date=desc" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/field-force"
);
...
```bash
curl -X POST \
    "http://nexusweb.jwsistemas.com.br/connector/api/field-force/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":14,"visit_to":"vero","visit_address":"veniam","assigned_to":10,"visit_on":"2021-12-28 17:23:00","visit_for":"ut"}'
...
```bash
curl -X POST \
    "http://nexusweb.jwsistemas.com.br/connector/api/field-force/update-visit-status/17" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"status":"finished","reason_to_not_meet_contact":"natus","visited_on":"2021-12-28 17:23:00","visited_address":"Radhanath Mullick Ln, Tiretta Bazaar, Bow Bazaar, Kolkata, West Bengal, 700 073, India","latitude":"41.40338","longitude":"2.17403","comments":"est","photo":"nemo"}'
...
let body = {
    "status": "finished",
    "reason_to_not_meet_contact": "natus",
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/product?order_by=ut&order_direction=in&brand_id=architecto&category_id=esse&sub_category_id=doloribus&location_id=1&selling_price_group=perspiciatis&send_lot_detail=qui&name=sapiente&sku=in&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/product"
);
...
let params = {
    ...
    "brand_id": "architecto",
    "category_id": "esse",
    "sub_category_id": "doloribus",
    "location_id": "1",
    "selling_price_group": "perspiciatis",
    "send_lot_detail": "qui",
    "name": "sapiente",
    "sku": "in",
    "per_page": "10",
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/product/1?selling_price_group=iusto&send_lot_detail=autem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/product/1"
);

let params = {
    "selling_price_group": "iusto",
    "send_lot_detail": "autem",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/variation/2?product_id=ipsam&location_id=1&brand_id=laboriosam&category_id=accusantium&sub_category_id=quisquam&not_for_selling=ex&name=voluptas&sku=ratione&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/variation/2"
);
...
let params = {
    ...
    "location_id": "1",
    "brand_id": "laboriosam",
    "category_id": "accusantium",
    "sub_category_id": "quisquam",
    "not_for_selling": "ex",
    "name": "voluptas",
    "sku": "ratione",
    "per_page": "10",
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/sell?location_id=1&contact_id=est&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=sed&service_staff_id=temporibus&shipping_status=ordered&source=minima&only_subscriptions=soluta&send_purchase_details=molestiae&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/sell"
);
...
let params = {
    ...
    "source": "minima",
    "only_subscriptions": "soluta",
    "send_purchase_details": "molestiae",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":1,"contact_id":20,"transaction_date":"2020-07-22 15:48:29","invoice_no":"earum","source":"api, phone, woocommerce","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":14,"discount_amount":10,"discount_type":"fixed","sale_note":"aperiam","staff_note":"quod","commission_agent":5,"shipping_details":"Express Delivery","shipping_address":"nostrum","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":20,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":12,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"neque","recur_repetitions":18,"rp_redeemed":15,"rp_redeemed_amount":13.5,"types_of_service_id":7,"service_custom_field_1":"quisquam","service_custom_field_2":"porro","service_custom_field_3":"itaque","service_custom_field_4":"expedita","service_custom_field_5":"non","service_custom_field_6":"voluptatem","round_off_amount":383628971.74417907,"table_id":13,"service_staff_id":14,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":17,"note":"error"}],"payments":[{"amount":453.13,"method":"cash","account_id":12,"card_number":"iste","card_holder_name":"voluptas","card_transaction_number":"laudantium","card_type":"possimus","card_month":"debitis","card_year":"sed","card_security":"et","transaction_no_1":"suscipit","transaction_no_2":"error","transaction_no_3":"est","bank_account_number":"et","note":"eum","cheque_number":"corrupti"}]}]}'
    ...
    "sells": [
        {
            ...
            "recur_interval_type": "months",
            "subscription_repeat_on": 15,
            "subscription_no": "neque",
            "recur_repetitions": 18,
            "rp_redeemed": 15,
            "rp_redeemed_amount": 13.5,
            "types_of_service_id": 7,
            "service_custom_field_1": "quisquam",
            "service_custom_field_2": "porro",
            "service_custom_field_3": "itaque",
            "service_custom_field_4": "expedita",
            "service_custom_field_5": "non",
            "service_custom_field_6": "voluptatem",
            "round_off_amount": 383628971.74417907,
            "table_id": 13,
            "service_staff_id": 14,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_transaction_number": "laudantium",
                    "card_type": "possimus",
                    "card_month": "debitis",
                    "card_year": "sed",
                    "card_security": "et",
                    "transaction_no_1": "suscipit",
                    "transaction_no_2": "error",
                    "transaction_no_3": "est",
                    "bank_account_number": "et",
                    "note": "eum",
                    "cheque_number": "corrupti"
                }
            ]
        }
    ]
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/sell/55?send_purchase_details=ratione" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/sell/55"
);

let params = {
    "send_purchase_details": "ratione",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X PUT \
    "http://nexusweb.jwsistemas.com.br/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":16,"discount_amount":10,"discount_type":"fixed","sale_note":"autem","source":"voluptas","staff_note":"sunt","is_suspend":false,"commission_agent":19,"shipping_details":"Express Delivery","shipping_address":"voluptatem","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":1,"pay_term_number":5,"pay_term_type":"months","is_recurring":0,"recur_interval":12,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"voluptas","recur_repetitions":5,"rp_redeemed":5,"rp_redeemed_amount":13.5,"types_of_service_id":11,"service_custom_field_1":"expedita","service_custom_field_2":"corrupti","service_custom_field_3":"est","service_custom_field_4":"error","service_custom_field_5":"porro","service_custom_field_6":"necessitatibus","round_off_amount":2459439.5095467195,"table_id":19,"service_staff_id":14,"change_return":0,"change_return_id":17,"products":[{"sell_line_id":7,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":20,"discount_amount":0,"discount_type":"percentage","sub_unit_id":14,"note":"quod"}],"payments":[{"payment_id":3,"amount":453.13,"method":"cash","account_id":7,"card_number":"illum","card_holder_name":"error","card_transaction_number":"nostrum","card_type":"omnis","card_month":"sed","card_year":"nostrum","card_security":"consequuntur","transaction_no_1":"quia","transaction_no_2":"sed","transaction_no_3":"eveniet","note":"ratione","cheque_number":"et","bank_account_number":"aspernatur"}]}'
...
let body = {
    ...
    "rp_redeemed": 5,
    "rp_redeemed_amount": 13.5,
    "types_of_service_id": 11,
    "service_custom_field_1": "expedita",
    "service_custom_field_2": "corrupti",
    "service_custom_field_3": "est",
    "service_custom_field_4": "error",
    "service_custom_field_5": "porro",
    "service_custom_field_6": "necessitatibus",
    "round_off_amount": 2459439.5095467195,
    "table_id": 19,
    "service_staff_id": 14,
    "change_return": 0,
    "change_return_id": 17,
...
```bash
curl -X DELETE \
    "http://nexusweb.jwsistemas.com.br/connector/api/sell/architecto" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "http://nexusweb.jwsistemas.com.br/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":8,"transaction_date":"2020-5-7 15:20:22","invoice_no":"ipsam","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":2,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "http://nexusweb.jwsistemas.com.br/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":6,"shipping_status":"ordered","delivered_to":"vel"}'
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/table?location_id=1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/table"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/taxonomy?type=minima" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/user/loggedin"
);
...
```bash
curl -X POST \
    "http://nexusweb.jwsistemas.com.br/connector/api/user-registration" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"laboriosam","first_name":"asperiores","last_name":"et","email":"incidunt","is_active":"rerum","user_type":"enim","crm_contact_id":16,"allow_login":false,"username":"officiis","password":"laboriosam","role":3,"access_all_locations":true,"location_permissions":[],"cmmsn_percent":"et","max_sales_discount_percent":"omnis","selected_contacts":true,"selected_contact_ids":[],"dob":"ducimus","gender":"facilis","marital_status":"tempora","blood_group":"sed","contact_number":"suscipit","alt_number":"ea","family_number":"natus","fb_link":"optio","twitter_link":"dolores","social_media_1":"numquam","social_media_2":"atque","custom_field_1":"repellendus","custom_field_2":"rerum","custom_field_3":"est","custom_field_4":"qui","guardian_name":"et","id_proof_name":"vel","id_proof_number":"quasi","permanent_address":"commodi","current_address":"est","bank_details":[{"account_holder_name":"aut","account_number":"natus","bank_name":"enim","bank_code":"in","branch":"illo","tax_payer_id":"sit"}]}'
...
let body = {
    ...
    "dob": "ducimus",
    "gender": "facilis",
    "marital_status": "tempora",
    "blood_group": "sed",
    "contact_number": "suscipit",
    "alt_number": "ea",
    "family_number": "natus",
    "fb_link": "optio",
    "twitter_link": "dolores",
    "social_media_1": "numquam",
    "social_media_2": "atque",
    ...
    "permanent_address": "commodi",
    "current_address": "est",
    "bank_details": [
        {
            "account_holder_name": "aut",
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/user?service_staff=ea" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/user"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/user/1"
);
...
```bash
curl -X POST \
    "http://nexusweb.jwsistemas.com.br/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"non","new_password":"labore"}'
...
```bash
curl -X POST \
    "http://nexusweb.jwsistemas.com.br/connector/api/forget-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"email":"itaque"}'
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/profit-loss-report?location_id=1&start_date=2018-06-25&end_date=2018-06-25&user_id=1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/notifications"
);
...
```bash
curl -X GET \
    -G "http://nexusweb.jwsistemas.com.br/connector/api/get-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
...
```javascript
const url = new URL(
    "http://nexusweb.jwsistemas.com.br/connector/api/get-location"
);
