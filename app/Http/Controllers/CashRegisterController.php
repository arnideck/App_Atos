...
class CashRegisterController extends Controller
{
    ...
    public function getRegisterDetails()
    {
        ...
        return view('cash_register.register_details')->with(
            compact('register_details', 'details', 'payment_types', 'close_time')
        );
    }
    ...
    public function getCloseRegister($id = null)
    {
        ...
        $user_id = !empty($id) ? $register_details->user_id : auth()->user()->id;
        $open_time = $register_details['open_time'];
        $close_time = \Carbon::now()->toDateTimeString();
        ...
        $details = $this->cashRegisterUtil->getRegisterTransactionDetails($user_id, $open_time, $close_time, $is_types_of_service_enabled);
        $payment_types = $this->cashRegisterUtil->payment_types($register_details->location_id, true, $business_id);
        $transactions_payment_types = $this->transactionUtil->payment_types(null, false, $business_id);

        $payment_types = $payment_types + $transactions_payment_types;
